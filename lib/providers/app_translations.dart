...
final Map<String, String> en = {
  ...
  'LessonCompleteText1': 'If you now and in the future follow all the recommendations given in this tutorial your cyber security will be much improved.',
  'LessonCompleteText2': 'It is recommended that you revisit this lesson in the future to keep practising.',
  ...
  'MyCommentsNoComments': 'Your comments written in the different lessons will appear here. \n \nSo far you have either not written any or dismissed them all.',
  'MyCommentsDismissInstruction': 'To dismiss comments drag them to the all the way to the left.',

  'ProfileTitle': 'Profile',
  'ProfileChangeAvatar': 'Change Image',
  'ProfileUserName': 'Username',
  'ProfileLearnScore': 'Learn-Score',
  'ProfileText1': "The learn-score helps you track your own as well as other people's overall progress and knowledge in the discussion platform. Share your score with your co-workers to see who is the furthest.\n\nImprove your score by finishing lessons.",
  'ProfileExportLearningProgress': 'Export Learning Progress',

  'SettingsTitle': 'Settings',
  'SettingsDarkMode': 'Dark Mode',
  'SettingsLessons': 'Lessons',
  'SettingsSetDisplayAnonymous': 'Display your name as Anonymous on discussion platform',
  'SettingsSetDisplayScore': 'Display your learn-score on discussion platform',

  'ChatTitle': 'Discussion: ',
  'ChatNoInternetConnection': 'NO INTERNET CONNECTION AVAILABLE\n\nMake sure you have a stable connection to the internet in order to be able to use the GEIGER Mobile discussion platform.',
  'ChatDeleteMessage': 'Delete Message?',
  'ChatDeleteMessagePopup': 'By deleting your message you will delete it for everybody.\n\nAre you sure you want to do this?',
...
final Map<String, String> de = {
  ...
  'LessonCompleteText1': 'Wenn du ab jetzt den Empfehlungen aus diesem Tutorial folgst, wird deine Cybersicherheit sehr verbessert.',
  'LessonCompleteText2': 'Es ist empfohlen, dass du diese Lektion in der Zukunft wiederholst, um weiterzuüben',
  ...
  'MyCommentsNoComments': 'Deine Kommentare aus den Lektionen werden hier erscheinen. \n \nMomentan hast du keine Kommentare.',
  'MyCommentsDismissInstruction': 'Um einen Kommentar zu löschen, ziehe ihn nach links.',

  'ProfileTitle': 'Profil',
  'ProfileChangeAvatar': 'Bild ändern',
  'ProfileUserName': 'Benutzername',
  'ProfileLearnScore': 'Lern-Score',
  'ProfileText1': "Der Lern-Score hilft dir, das Wissen und den Fortschritt von dir und anderen zu verfolgen. Teile deinen Score mit anderen um zu sehen, wer am weitesten ist.\n\nVerbessere deinen Score indem du Lektionen abschliesst.",
